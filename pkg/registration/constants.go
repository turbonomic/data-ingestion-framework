...
const (
	DefaultPropertyNamespace = "DEFAULT" // the default namespace of entity property

	TargetIdField      = "targetIdentifier" // this is used to uniquely identify the target
	TargetNameField    = "Name"             // this is used to display the target name
	TargetAddressField = "address"          // this is used to display the target address
	ProbeVersion       = "probeVersion"     // this is used to display the probe version

	propertyId = "id" // this is used to identify an entity

	TargetTypeOverwriteEnv = "TURBODIF_TARGET_TYPE_OVERWRITE"

	PrometurboProbeCategory   = "Observability"
	PrometurboProbeUICategory = "Observability"
	PrometurboTargetType      = "Prometheus"
)
...
var TemplateEntityTypeMap = map[string]proto.EntityDTO_EntityType{
	...
	"CONTAINER_SPEC":                  proto.EntityDTO_CONTAINER_SPEC,
	"WORKLOAD_CONTROLLER":             proto.EntityDTO_WORKLOAD_CONTROLLER,
	"NAMESPACE":                       proto.EntityDTO_NAMESPACE,
	"CONTAINER_PLATFORM_CLUSTER":      proto.EntityDTO_CONTAINER_PLATFORM_CLUSTER,
...
var TemplateCommodityTypeMap = map[string]proto.CommodityDTO_CommodityType{
	...
	"ENERGY":                     proto.CommodityDTO_ENERGY,
	...
	"GPU":                        proto.CommodityDTO_GPU,
	"GPU_MEM":                    proto.CommodityDTO_GPU_MEM,
	"GPU_REQUEST":                proto.CommodityDTO_GPU_REQUEST,
	"GPU_REQUEST_QUOTA":          proto.CommodityDTO_GPU_REQUEST_QUOTA,
	"SERVICE_TIME":               proto.CommodityDTO_SERVICE_TIME,
	"QUEUING_TIME":               proto.CommodityDTO_QUEUING_TIME,
	"LLM_CACHE":                  proto.CommodityDTO_LLM_CACHE,
	"CONCURRENT_QUERIES":         proto.CommodityDTO_CONCURRENT_QUERIES,
}
...
var SoldCommKeySupplierMapping = map[proto.EntityDTO_EntityType]set.Set{
	...
	proto.EntityDTO_VIRTUAL_MACHINE:       set.NewSet(proto.EntityDTO_CONTAINER_POD),
}
...
var BoughtCommKeySupplierMapping = map[proto.EntityDTO_EntityType]set.Set{
	...
	proto.EntityDTO_CONTAINER_POD:         set.NewSet(proto.EntityDTO_WORKLOAD_CONTROLLER),
	proto.EntityDTO_CONTAINER:             set.NewSet(proto.EntityDTO_CONTAINER_POD),
}
